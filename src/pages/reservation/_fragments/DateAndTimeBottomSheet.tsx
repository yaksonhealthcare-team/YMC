    ...
    <div className={'flex flex-col items-center gap-5 px-5 pb-[100px]'}>
      ...
      {selectedDate ? (
        ...
        <div className="w-full p-4 bg-[#f7f7f7] rounded-lg">
          <div className="text-center text-[#212121] text-sm">날짜를 먼저 선택해 주세요.</div>
        </div>
      )}
...
const StyledDateCalendar = styled(DateCalendar)<DateCalendarProps<Dayjs>>(({ theme }) => ({
  maxWidth: '355px',
  height: 'auto',
  // 전체 달력 레이아웃
          ...
          <div className="grid grid-cols-4 gap-[9px]">
            {timeSlots.length > 0 ? (
              ...
              <div className="col-span-4 p-4 bg-[#f7f7f7] rounded-lg">
                <div className="text-center text-[#212121] text-sm">이 날짜에 가능한 시간이 없습니다.</div>
              </div>
            )}
          </div>
        </div>
