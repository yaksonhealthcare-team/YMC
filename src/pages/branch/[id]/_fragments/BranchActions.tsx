...
const BranchActions = memo(({ branch, onBookmark, onReservation }: BranchActionsProps) => {
  return (
    <div className={'z-10 fixed bottom-0 left-0 right-0 flex flex-col items-center justify-center w-full bg-white'}>
