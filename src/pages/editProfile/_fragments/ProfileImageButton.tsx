...
const ProfileImageButton = ({ profileImageUrl, onImageChange, onPreviewImageChange }: ProfileImageButtonProps) => {
  ...
  return (
    <div className="relative w-20 h-20">
      {profileImageUrl ? (
        <>
          <button type="button" onClick={handleImageUploadClick} className="w-full h-full p-0 border-0 bg-transparent">
            <Image src={profileImageUrl} alt="프로필" className="w-full h-full rounded-full object-cover" />
          </button>
          <button
            type="button"
            onClick={(e) => {
