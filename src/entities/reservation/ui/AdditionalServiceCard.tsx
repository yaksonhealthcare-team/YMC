...
export const AdditionalServiceCard = ({ option, isChecked, onChangeService }: AdditionalServiceCardProps) => {
  return (
    <div key={option.s_idx} className="p-5 bg-white rounded-xl border border-gray-100 flex flex-col gap-2">
      <div className="flex justify-between items-center">
        <p className="text-[#212121] text-16px font-m leading-[23.68px]">{option.s_name}</p>
        <button
          type="button"
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-500 text-14px font-r leading-[20.72px]">{Number(option.s_time || 0)}분 소요</span>
        </div>
