...
export default function FilledCheckIcon({ isActive, ...props }: FilledCheckIconProps) {
  return (
    <SvgIcon {...props}>
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
        <path
          ...
          fill={isActive ? props.color || props.htmlColor || '#F37165' : '#DDDDDD'}
          stroke={isActive ? props.color || props.htmlColor || '#F37165' : '#DDDDDD'}
          strokeWidth="1.5"
          strokeLinecap="round"
