import { convertMembershipForSwiperBySlot } from '@/_domain/membership/business/membership.business';
import { ConvertedConsultMenuData } from '@/_domain/reservation/business';
import { isConsultReservationType, isReservationType, ReservationFormValues } from '@/_domain/reservation/types';
