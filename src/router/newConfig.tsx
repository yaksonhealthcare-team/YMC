...
const noAuthRoutes: CustomRouteObject[] = [
  ...
  { path: '/terms/service', element: <ServiceTermsPage />, noAuth: true },
  { path: '/terms/privacy', element: <PrivacyTermsPage />, noAuth: true },
  { path: '/terms/location', element: <LocationTermsPage />, noAuth: true },
  { path: '/terms/marketing', element: <MarketingTermsPage />, noAuth: true }
];

const routeConfig: CustomRouteObject[] = [...authRoutes, ...noAuthRoutes];
